/************************************************************************************************/
/* Programma che sfutta la programmazione multi-thread per il calcolo dei primi n numeri interi */
/************************************************************************************************/
...
int main (int argc, char *argv[])
{
  ...
  pthread_t tid; /* identificativo univoco del thread */
  ...
  /* Posso creare e lanciare il thread */
  pthread_create (&tid,
                  &attr,
                  runner,
                  argv[1]);
